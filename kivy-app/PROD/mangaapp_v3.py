"""This is a stable version of the one file python script of the mangaapp application. Currently it uses the .kv file as a load_string
instead of a seperate file. This was done to make packaging it easier."""
