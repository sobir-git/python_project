"""This is version 5 PROD of the manga app. This new version includes a second screen to pull in updated
"hot" manga from the source www.mangatown.com 
** NOTE: The second screen only has GUI layed out the next version will include url links to open when
pulling in the new information"""
